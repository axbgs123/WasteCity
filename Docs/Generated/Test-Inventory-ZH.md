...
## 6. 失败定位用的源码路径与受控需求编号
- 建筑建造与疏散：源码 `Assets/_Game/Rendering/Graybox3D/GrayboxPreview.mat`、`Assets/_Game/Scripts/Building/**`、`Assets/_Game/Scripts/Building/BuildingResourceNodeCompatibilityRules.cs`、`Assets/_Game/Scripts/Graybox3D/Building/*.cs`；需求 `BUG-0006`、`DOC-0001`、`IDEA-0005`、`IDEA-0008`、`IDEA-0009`、`IDEA-0010`、`IDEA-0012`
...
- 研究与人口：源码 `Assets/_Game/Scripts/Narrative/**`、`Assets/_Game/Scripts/Population/**`、`Assets/_Game/Scripts/Progression/**`、`Assets/_Game/Scripts/Research/**`；需求 `DOC-0001`、`IDEA-0011`
