...
- 战斗与路线：源码 `Assets/_Game/Scripts/Combat/**`、`Assets/_Game/Scripts/Content/RouteContentDisplayCatalog.cs`、`Assets/_Game/Scripts/Defense/**`、`Assets/_Game/Scripts/Graybox3D/Building/GrayboxDefense*.cs`；需求 `DOC-0001`、`IDEA-0013`、`IDEA-0014`
...
- 持久化与迁移：源码 `Assets/_Game/Scripts/Graybox3D/Building/GrayboxEconomySaveAdapter3D.cs`、`Assets/_Game/Scripts/Graybox3D/Building/GrayboxProductionSaveAdapter3D.cs`、`Assets/_Game/Scripts/Persistence/**`；需求 `DOC-0001`、`IDEA-0015`
