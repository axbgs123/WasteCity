...
- 场景编辑构建与性能：源码 `Assets/_Game/Editor/FirstArtPassImportPolicy.cs`、`Assets/_Game/Editor/FirstArtTerrainAssetBuilder.cs`、`Assets/_Game/Editor/FirstArtTerrainEvidenceCapture.cs`、`Assets/_Game/Editor/FormalBuildTools.cs`、`Assets/_Game/Editor/FormalProjectSetup.cs`、`Assets/_Game/Editor/GrayboxPerformanceProbe.cs`、`Assets/_Game/Editor/GrayboxSceneAuthoring.cs`、`Assets/_Game/Editor/ProjectQuality/ProjectDocumentationGenerator.cs`、`Assets/_Game/Editor/ProjectQuality/ProjectQualityCatalogLoader.cs`、`Assets/_Game/Editor/ProjectQuality/ProjectQualityModels.cs`、`Assets/_Game/Editor/ProjectQuality/ProjectQualityScanner.cs`、`Assets/_Game/Editor/ProjectQuality/ProjectQualityTools.cs`、`Assets/_Game/Editor/ProjectQuality/ProjectQualityValidator.cs`、`Assets/_Game/Editor/ProjectQuality/ProjectTestResultAnalyzer.cs`、`Assets/_Game/Scripts/Graybox3D/GrayboxSceneBootstrap.cs`、`Assets/_Game/Scripts/Graybox3D/GrayboxUrpScope.cs`；需求 `DOC-0001`
