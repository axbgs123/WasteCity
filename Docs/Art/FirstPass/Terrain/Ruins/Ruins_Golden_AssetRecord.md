...
- Git：正式候选资产提交为 `45229bf93d4c558deb974e2e4e1af0dccce9ec8a`（`art: add approved ruins terrain material`）；用户正式批准由后续纯文档提交记录，不改写候选资产历史
...
| `ArtSource/FirstPass/Environment/Terrain/Ruins/References/Ruins_Golden_SourceNotes.md` | UTF-8 Markdown | `98e02f95a31f536cec499d439aa16b2aab97330d861c3e2838397e458f41e1a8` |
...
- 用户于 2026-08-09 查看 4×4 平铺、默认倾斜正交和 PBR 三张正式检查图后回复“通过”，本版 `Ruins` 正式地表材质视觉验收通过。
