...
namespace WasteCity.Persistence
{
    ...
    public static class FormalSaveCodec
    {
        ...
        { if(string.IsNullOrWhiteSpace(json)) return null; try { var d=JsonUtility.FromJson<FormalSaveData>(json); return d!=null&&(d.schema>=1&&d.schema<=13)?d:null; } catch { return null; } }
    }
}
