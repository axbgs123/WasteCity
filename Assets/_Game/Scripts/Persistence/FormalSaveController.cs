...
namespace WasteCity.Persistence
{
    public sealed class FormalSaveController : MonoBehaviour
    {
        ...
        public bool Apply(FormalSaveData d,bool preserveObservation)
        {
            ...
            city.RestoreNavigation(d.schema>=30&&d.cityAutopilotActive,d.cityDestinationX,d.cityDestinationY);
            leader.RestorePosition(d.leaderX,d.leaderY,d.schema>=30&&d.leaderPositionSaved);
