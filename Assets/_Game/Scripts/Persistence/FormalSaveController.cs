...
namespace WasteCity.Persistence
{
    public sealed class FormalSaveController : MonoBehaviour
    {
        ...
        public bool Apply(FormalSaveData d,bool preserveObservation)
        {
            ...
            technology?.Restore(d.schema>=26?d.technologyOverloadCooldown:0f,d.schema>=26?d.technologyOverloadBoost:0f,d.schema>=26?d.technologyOverloadLockout:0f);
