...
namespace WasteCity.Narrative
{
    ...
    public sealed class GuidanceFlowModel
    {
        ...
        public string Objective=>Stage==GuidanceStage.Awakening?"使用 WASD 驾驶城市移动至少 3 格":Stage==GuidanceStage.Discovery?"寻找铁矿脉，按 F 展开为堡垒":Stage==GuidanceStage.FirstFortress?"按 B 打开建造，在铁矿脉上建造采矿站":Stage==GuidanceStage.ProductionChain?"研究自动机械，完成冶炼→装配→机枪塔链条":Stage==GuidanceStage.PressureTest?"扩充弹药与防线，击退 30/60 关注度攻击":Stage==GuidanceStage.Broodmother?"准备撤离或坚守，击败 90 关注度晶壳母体":Stage==GuidanceStage.Advancement?"完成遗产解析、两座机枪塔与持续生产，然后按 U 主动升阶":"首个文明循环已完成，可继续建设与测试";
