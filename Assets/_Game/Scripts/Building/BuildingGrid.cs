...
namespace WasteCity.Building
{
    ...
    public static class BuildingCatalog
    {
        ...
        public static readonly BuildingDefinition ResearchStation=new BuildingDefinition("core.building.research-station", "研究站", 2, 2, ResourceIds.Iron, 6, false, 10f, 260, 200, placement:BuildingPlacement.Either);
