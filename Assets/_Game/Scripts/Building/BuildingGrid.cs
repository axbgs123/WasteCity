...
namespace WasteCity.Building
{
    ...
    public static class BuildingCatalog
    {
        ...
        public static readonly BuildingDefinition ResearchStation=new BuildingDefinition("core.building.research-station", "研究站", 2, 2, ResourceIds.Iron, 6, false, 10f, 260, placement:BuildingPlacement.Either, operation:BuildingOperation.MobileAllowed);
        ...
        public static readonly BuildingDefinition PsionicMechFactory=new BuildingDefinition("bridge.building.psionic-mech-factory","灵能机甲厂",3,2,ResourceIds.Alloy,20,false,16f,420,0,"core.research.bridge.psionic-mech","psionics.building.workshop");
        public static readonly BuildingDefinition HighFrequencySwordForge=new BuildingDefinition("bridge.building.high-frequency-sword-forge","高周波飞剑铸造台",2,2,ResourceIds.SpiritIron,18,false,12f,340,0,"core.research.bridge.high-frequency-sword","cultivation.building.artifact-workshop");
        public static readonly BuildingDefinition BioHangar=new BuildingDefinition("bridge.building.bio-hangar","生物机库",3,2,ResourceIds.BoneSteel,20,false,16f,440,0,"core.research.bridge.bio-hangar","biological.building.breeding-chamber");
        public static readonly BuildingDefinition SpiritPlantGarden=new BuildingDefinition("bridge.building.spirit-plant-garden","灵植园",2,2,ResourceIds.SpiritIron,14,false,12f,320,0,"core.research.bridge.spirit-plant","biological.building.breeding-chamber");
        public static readonly BuildingDefinition EmpTower=new BuildingDefinition("bridge.building.emp-tower","EMP塔",1,1,ResourceIds.PsionicAmplifier,16,false,12f,300,0,"core.research.bridge.psionic-pulse","psionics.building.workshop");
        public static readonly BuildingDefinition[] All =
        {
            MiningStation,Housing,Warehouse,Wall,ResearchStation,Smelter,Assembler,MachineGunTurret,HeavyMachineGunTurret,PowerPlant,SpiritFireFurnace,ArtifactWorkshop,SwordArrayTower,SwordRidingPlatform,ColonyPool,BreedingChamber,SporeTower,MetabolicFurnace,ResonanceFurnace,PsionicWorkshop,MindSpire,ConsciousnessNetwork,LaserTower,AcidTower,ShieldGenerator,SpiritGatheringArray,AutomatedRepairBay,AlchemyChamber,PuppetWorkshop,BehemothPen,PsionicMechFactory,HighFrequencySwordForge,BioHangar,SpiritPlantGarden,EmpTower
        };
        public static readonly BuildingDefinition[] BuildMenu={MiningStation,Housing,Warehouse,Wall,ResearchStation,Smelter,Assembler,MachineGunTurret,PowerPlant,SpiritFireFurnace,ArtifactWorkshop,SwordArrayTower,ColonyPool,BreedingChamber,SporeTower,MetabolicFurnace,ResonanceFurnace,PsionicWorkshop,MindSpire,ConsciousnessNetwork,LaserTower,AcidTower,ShieldGenerator,SpiritGatheringArray,AutomatedRepairBay,AlchemyChamber,PuppetWorkshop,BehemothPen,PsionicMechFactory,HighFrequencySwordForge,BioHangar,SpiritPlantGarden,EmpTower};
    }
