    ...
    public static class GrayboxDeveloperCatalogQuery3D
    {
        ...
        private static GrayboxDeveloperCatalogEntry3D[] BuildActions()
        {
            ...
            definitions.AddRange(new[]
            {
                ...
                ("developer.exploration.reveal-all", "探索整张地图"),
                ("developer.exploration.gather-ready", "准备领袖手采验收"),
                ("developer.exploration.outpost-normal", "设置前哨正常运行"),
                ("developer.exploration.outpost-communication-off", "设置前哨通信中断"),
                ("developer.exploration.outpost-supply-off", "设置前哨补给中断"),
                ("developer.exploration.outpost-maintenance-off", "设置前哨维护中断"),
                ("developer.exploration.alert-guard", "设置前哨警戒警报"),
                ("developer.exploration.alert-under-attack", "设置前哨受袭警报"),
                ("developer.exploration.alert-critical", "设置前哨危急警报"),
                ("developer.exploration.alert-clear", "清除前哨警报"),
                ...
                ("developer.query.exploration-vision-sources", "查询探索视野来源"),
                ("developer.query.exploration-cell-visibility", "查询指定格视野状态"),
                ("developer.query.exploration-scan-zones", "查询探索扫描区状态"),
                ("developer.query.exploration-intel", "查询探索情报状态"),
                ("developer.query.exploration-outpost-alerts", "查询前哨警报快照"),
            });
            var result = new GrayboxDeveloperCatalogEntry3D[
                definitions.Count];
            for (var index = 0; index < result.Length; index++)
