...
{
    [Serializable] public sealed class EnemySnapshot { public int archetype,quality,waveTrigger,health,shield,infectionStacks,swordIntentStacks;public float x,y,infectionElapsed;public bool controlled;public BossEncounterSnapshot boss; }
