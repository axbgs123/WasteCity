...
namespace WasteCity.Economy
{
    public sealed class TechnologyProductionController : MonoBehaviour
    {
        ...
        public bool HasRunningProduction=>ActiveMines>0||new[]{smelter,assembler,spiritFire,artifactWorkshop,boneSteel,concentrate,resonance,psionicWorkshop}.Any(value=>value.Status==ProductionStatus.Running)||breeding.Status==ProductionStatus.Running;
        ...
        private void Update()
        {
            ...
            int spiritFires=0,artifactWorkshops=0,colonyPools=0,breedingChambers=0,resonanceFurnaces=0,psionicWorkshops=0;
