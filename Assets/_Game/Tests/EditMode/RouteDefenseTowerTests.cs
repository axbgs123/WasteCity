...
namespace WasteCity.Tests
{
    public sealed class RouteDefenseTowerTests
    {
        ...
        [Test] public void BuildMenuExcludesUpgradeOnlyTowers(){Assert.That(BuildingCatalog.BuildMenu,Has.Member(BuildingCatalog.SwordArrayTower));Assert.That(BuildingCatalog.BuildMenu,Has.No.Member(BuildingCatalog.HeavyMachineGunTurret));Assert.That(BuildingCatalog.BuildMenu,Has.No.Member(BuildingCatalog.SwordRidingPlatform));Assert.That(BuildingCatalog.All,Has.Member(BuildingCatalog.SwordRidingPlatform));Assert.That(DefenseTowerCatalog.For(BuildingCatalog.SwordRidingPlatform.Id.Value).DamageType,Is.EqualTo(DamageType.TrueEssence));}
