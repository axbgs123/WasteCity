...
namespace WasteCity.Tests
{
    public sealed class FormalWorldPresentationScaleProfile3DTests
    {
        ...
        public void IDEA0019_DefaultCameraUsesMidMarkerWithoutNames()
        {
            ...
            Assert.That(ReadFloat(metrics, "FrameReferencePixels"), Is.EqualTo(28f));
            Assert.That(ReadFloat(metrics, "IconReferencePixels"), Is.EqualTo(20f));
            Assert.That(ReadFloat(metrics, "TextReferencePixels"), Is.EqualTo(13f));
        }
