...
namespace WasteCity.Tests
{
    public sealed class WaveDirectorTests
    {
        ...
        [Test] public void PostAdvanceCycleHasACompleteMixedWave(){var wave=WaveCatalog.ForTrigger(120);Assert.That(wave,Is.Not.Null);Assert.That(wave.TotalCount,Is.GreaterThan(20));Assert.That(wave.Entries.Count,Is.GreaterThanOrEqualTo(4));}
        [Test] public void WarningMultiplierAffectsNewlyStartedWave(){var model=new WaveDirectorModel();model.SetWarningMultiplier(1.5f);model.Schedule(30);Assert.That(model.WarningRemaining,Is.EqualTo(90f));}
    }
}
