...
namespace WasteCity.Tests
{
    public sealed class RescueSiteTests
    {
        ...
        { var a=new RescueSiteModel(32,24,new WorldSeed(8128));var b=new RescueSiteModel(32,24,new WorldSeed(8128));Assert.That(a.Sites.Count,Is.EqualTo(3));for(int i=0;i<3;i++){Assert.That(a.Sites[i].X,Is.EqualTo(b.Sites[i].X));Assert.That(a.Sites[i].Y,Is.EqualTo(b.Sites[i].Y));}Assert.That(a.Sites[0].X==a.Sites[1].X&&a.Sites[0].Y==a.Sites[1].Y,Is.False);}
