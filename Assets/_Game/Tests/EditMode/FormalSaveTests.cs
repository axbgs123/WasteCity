...
namespace WasteCity.Tests
{
    public sealed class FormalSaveTests
    {
        ...
        [Test] public void ElixirRoundTripsInCurrentSchema(){var restored=FormalSaveCodec.Decode(FormalSaveCodec.Encode(new FormalSaveData{elixir=4}));Assert.That(restored.schema,Is.EqualTo(24));Assert.That(restored.elixir,Is.EqualTo(4));}
        ...
        {
            var data = new FormalSaveData { rallyFixed = true, rallyX = 7.5f, rallyY = -2.5f, puppetLosses = 2, behemothLosses = 3, controlledLosses = 4 };
