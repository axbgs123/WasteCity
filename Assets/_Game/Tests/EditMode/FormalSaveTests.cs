...
namespace WasteCity.Tests
{
    public sealed class FormalSaveTests
    {
        ...
        [Test] public void VersionTwentyOneElixirRoundTrips(){var restored=FormalSaveCodec.Decode(FormalSaveCodec.Encode(new FormalSaveData{elixir=4}));Assert.That(restored.schema,Is.EqualTo(21));Assert.That(restored.elixir,Is.EqualTo(4));}
