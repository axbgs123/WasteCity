        ...
        public void SchemaTwentyNineBuildingSiteRoundTrips()
        {
            var data = new FormalSaveData
            {
                ...
                buildings = new[]
                {
                    ...
                    {
                        definitionId = WasteCity.Building.BuildingCatalog.Housing.Id.Value,
                        site = (int)WasteCity.Building.BuildingSite.InnerCity
                    }
                }
            };
            ...
            Assert.That(
                ...
                Is.EqualTo((int)WasteCity.Building.BuildingSite.InnerCity));
        }
        [Test]
