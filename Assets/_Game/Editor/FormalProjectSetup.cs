...
namespace WasteCity.Editor
{
    public static class FormalProjectSetup
    {
        public static void Configure()
        {
            ...
            var friendlyUnits=systems.AddComponent<FormalFriendlyUnitController>();var friendlyData=new SerializedObject(friendlyUnits);friendlyData.FindProperty("economy").objectReferenceValue=economy;friendlyData.FindProperty("city").objectReferenceValue=city.GetComponent<PlaceholderMobileCity>();friendlyData.FindProperty("buildings").objectReferenceValue=buildingController;friendlyData.FindProperty("research").objectReferenceValue=research;friendlyData.ApplyModifiedPropertiesWithoutUndo();saveData.FindProperty("friendlyUnits").objectReferenceValue=friendlyUnits;saveData.ApplyModifiedPropertiesWithoutUndo();
            ...
            var technology=systems.AddComponent<FormalTechnologyRouteController>();var technologyData=new SerializedObject(technology);technologyData.FindProperty("research").objectReferenceValue=research;technologyData.FindProperty("leader").objectReferenceValue=leader;technologyData.FindProperty("city").objectReferenceValue=city.transform;technologyData.ApplyModifiedPropertiesWithoutUndo();buildingController.SetTurretCombatModifierSource(technology);saveData.FindProperty("technology").objectReferenceValue=technology;saveData.ApplyModifiedPropertiesWithoutUndo();
            var drones=systems.AddComponent<FormalDroneController>();var droneData=new SerializedObject(drones);droneData.FindProperty("research").objectReferenceValue=research;droneData.FindProperty("city").objectReferenceValue=city.transform;droneData.FindProperty("world").objectReferenceValue=worldView;droneData.FindProperty("buildings").objectReferenceValue=buildingController;droneData.ApplyModifiedPropertiesWithoutUndo();
